...
<script src="https://checkout.razorpay.com/v1/checkout.js"></script>
    ...
    <div class="container-xxl flex-grow-1" style="padding: 0px 10px;">
        <div class="card" style="margin-bottom:5px;min-height: 85vh !important;">
            ...
            <?php if($_SESSION['role_id']== 1 ){ echo '<center><img src="dist/access-denied.png" style="width:200px;"/><center>'; }else{  ?>
...
function editSkater(id) {
    ...
    // let url = selectedId ? 'api/skaters-for-clubs/update.php' : 'api/skaters-for-clubs/create.php';
    let url = 'api/front-api/register-skater.php';
    if (selectedId) {
...
function openPaymentGateWay(order_id, amount, razorpay_api_key) {
    ...
    var options = {
        ...
        "image": "assets/img/favicon/SSFI_main.png",
        "order_id": order_id, // Pass the order_id received from PHP
        "handler": function (response) {
            console.log("Payment Success:", response);
            
            fetch("api/front-api/payment_capture.php", {
                method: "POST",
                headers: {
...
function pay(id) {
    $.ajax({
        url: 'api/front-api/get-payment.php',
        type: 'POST',
        dataType: 'json',
        data: {skater_id:id},
        success: function (response) {
