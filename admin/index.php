<?php 
    ...
    $club = $pdo->prepare("SELECT id as club_counts FROM tbl_clubs");
    $club->execute();
    $club_query = $club->fetchAll(PDO::FETCH_ASSOC);
    $total_club = $club->rowCount();
    
    $skater = $pdo->prepare("SELECT id as skaters_counts FROM tbl_skaters");
    $skater->execute();
    $skater_query = $skater->fetchAll(PDO::FETCH_ASSOC);
    $total_skater = $skater->rowCount();
    
    $secretary = $pdo->prepare("SELECT 
        COUNT(CASE WHEN role_id = 2 THEN 1 END) AS district_counts,
        COUNT(CASE WHEN role_id = 3 THEN 1 END) AS state_counts
    FROM tbl_user");
    $secretary->execute();
    $secretary_query = $secretary->fetchAll(PDO::FETCH_ASSOC);
    $total_secretary = $secretary->rowCount();
    
    $events = $pdo->prepare("SELECT 
        COUNT(CASE WHEN event_level_type_id = 1 THEN 1 END) AS district_counts,
        COUNT(CASE WHEN event_level_type_id = 2 THEN 1 END) AS state_counts,
        COUNT(CASE WHEN event_level_type_id = 3 THEN 1 END) AS national_counts,
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row g-6">
            ...
            <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="mb-0"><?php echo $total_club; ?></h4>
                    </div>
                    <h6 class="mb-0 fw-normal">Club</h6>
                    <p class="mb-0">
            ...
            <div class="card card-border-shadow-warning h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="mb-0"><?php echo $total_skater; ?></h4>
                    </div>
                    <h6 class="mb-0 fw-normal">Skater</h6>
                    <p class="mb-0">
            ...
            <div class="card card-border-shadow-danger h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="mb-0"><?=$secretary_query[0]['district_counts']?></h4>
                    </div>
                    <h6 class="mb-0 fw-normal">District Secretary</h6>
                    <p class="mb-0">
            ...
            <div class="card card-border-shadow-info h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="mb-0"><?=$secretary_query[0]['state_counts']?></h4>
                    </div>
                    <h6 class="mb-0 fw-normal">State Secretary </h6>
                    <p class="mb-0">
            ...
            <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="mb-0"><?php echo $events_query[0]['total_events'] ?></h4>
                    </div>
                    <h6 class="mb-0 fw-normal">Total Events</h6>
                    <p class="mb-0">
                        <!--<span class="me-1 fw-medium">+18.2%</span>-->
                        <!--<small class="text-muted">than last week</small>-->
                    </p>
            ...
            <div class="card card-border-shadow-warning h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="mb-0"><?php echo $events_query[0]['district_counts'] ?></h4>
                    </div>
                    <h6 class="mb-0 fw-normal">District Events</h6>
                    <p class="mb-0">
                        <!--<span class="me-1 fw-medium">-8.7%</span>-->
                        <!--<small class="text-muted">than last week</small>-->
                    </p>
            ...
            <div class="card card-border-shadow-danger h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="mb-0"><?=$events_query[0]['state_counts']?></h4>
                    </div>
                    <h6 class="mb-0 fw-normal">State Events</h6>
                    <p class="mb-0">
                        <!--<span class="me-1 fw-medium">+4.3%</span>-->
                        <!--<small class="text-muted">than last week</small>-->
                    </p>
            ...
            <div class="card card-border-shadow-info h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h4 class="mb-0"><?=$events_query[0]['national_counts']?></h4>
                    </div>
                    <h6 class="mb-0 fw-normal">National Events </h6>
                    <p class="mb-0">
                        <!--<span class="me-1 fw-medium">-2.5%</span>-->
                        <!--<small class="text-muted">than last week</small>-->
                    </p>
        ...
        <!--                <h5 class="m-0 me-2">Category Overview</h5>-->
        <!--            </div>-->
        <!--            <div class="dropdown">-->
        <!--                <button-->
        ...
        <!--                <div class="vehicles-progress-label on-the-way-text" style="width: 39.7%">Beginor</div>-->
        <!--                <div class="vehicles-progress-label unloading-text" style="width: 28.3%">Inline</div>-->
        <!--                <div class="vehicles-progress-label loading-text" style="width: 17.4%">Fancy Inline</div>-->
        <!--                <div class="vehicles-progress-label waiting-text" style="width: 14.6%">Quad</div>-->
        <!--            </div>-->
        <!--            <div-->
        <!--                class="vehicles-overview-progress progress rounded-4 bg-transparent mb-2"-->
        <!--                style="height: 46px">-->
        <!--                <div-->
        <!--                    class="progress-bar small fw-medium text-start rounded-start bg-lighter text-heading px-1 px-lg-4"-->
        <!--                    role="progressbar"-->
        <!--                    style="width: 39.7%"-->
        <!--                    aria-valuenow="39.7"-->
        <!--                    aria-valuemin="0"-->
        ...
        <!--                                    </div>-->
        <!--                                    <h6 class="mb-0 fw-normal">Beginor</h6>-->
        <!--                                </div>-->
        <!--                            </td>-->
        ...
        <!--                                    </div>-->
        <!--                                    <h6 class="mb-0 fw-normal">Inline</h6>-->
        <!--                                </div>-->
        <!--                            </td>-->
                                    <!--<td class="text-end pe-0 text-nowrap">-->
        ...
        <!--                                    </div>-->
        <!--                                    <h6 class="mb-0 fw-normal">Fancy Inline</h6>-->
        <!--                                </div>-->
        <!--                            </td>-->
                                    <!--<td class="text-end pe-0 text-nowrap">-->
        ...
        <!--                                    </div>-->
        <!--                                    <h6 class="mb-0 fw-normal">Quad</h6>-->
        <!--                                </div>-->
        <!--                            </td>-->
                                    <!--<td class="text-end pe-0 text-nowrap">-->
        ...
        <!--        <div class="card-header d-flex align-items-center justify-content-between">-->
        <!--            <div class="card-title mb-0">-->
        <!--                <h5 class="m-0 me-2 mb-1">State statistics</h5>-->
        <!--                <p class="card-subtitle mb-0">Total number of register 23.8k</p>-->
        <!--            </div>-->
        <!--            <div class="btn-group">-->
        ...
        <!--<div class="col-lg-6 col-xxl-4 order-2 order-xxl-2" hidden>-->
        <!--    <div class="card h-100">-->
        ...
        <!--                            ><i class="ri-check-line text-success ri-24px"></i-->
        <!--                            ></span>-->
        <!--                    </div>-->
        <!--                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">-->
        <!--                        <div class="me-2">-->
        ...
        <!--                    <div class="avatar flex-shrink-0 me-3">-->
        <!--                        <span class="avatar-initial rounded-3 bg-label-warning"-->
        <!--                            ><i class="ri-home-line ri-24px"></i-->
        <!--                            ></span>-->
        <!--                    </div>-->
        <!--                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">-->
        <!--                        <div class="me-2">-->
        ...
        <!--<div class="col-md-6 col-xxl-4 order-1 order-xxl-3" hidden>-->
        <!--    <div class="card h-100">-->
        <!--        <div class="card-header d-flex align-items-center justify-content-between">-->
        <!--            <div class="card-title mb-0">-->
        <!--                <h5 class="m-0 me-2">Delivery by Branch</h5>-->
        <!--            </div>-->
        <!--            <div class="dropdown">-->
        <!--                <button-->
        <!--                    class="btn btn-text-secondary rounded-pill text-muted border-0 p-1"-->
        ...
        <!--/ Reasons for delivery exceptions -->
        <!-- Orders by Countries -->
        <!--<div class="col-md-6 col-xxl-4 order-0 order-xxl-4" hidden>-->
        <!--    <div class="card h-100">-->
        <!--        <div class="card-header d-flex justify-content-between">-->
        <!--            <div class="card-title mb-0">-->
        <!--                <h5 class="m-0 me-2">Orders by Shipment wise</h5>-->
