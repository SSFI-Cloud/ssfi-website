    ...
    <div class="container-xxl flex-grow-1" style="padding: 0px 10px;">
        <div class="card" style="margin-bottom:5px;">
            <div class="row" style="padding: 5px 5px;">
                    <div class="col-md-8">
                        <h6 class="card-header" ><i class="ri-file-list-3-fill"></i> District Secretary Form Details</h6>
                    </div>
                    <div class="col-md-4 text-end">
                        <a href="d-secretary-list.php"><button type="button" class="btn btn-xs rounded-pill btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#userModal">
                            <i class="ri-arrow-left-circle-fill"></i> &nbsp;&nbsp; Back to District Secretary List
                          </button></a>
                    </div>
            </div>    
...
<form id="secretary" novalidate enctype="multipart/form-data">
 ...
 <center><h6 class="mt-4">ID Details</h6></center>
<div class="col-sm-6">
...
<div class="col-sm-6">
    ...
    <div class="row mb-4">
        ...
        <div class="col-sm-12 text-end">
            <button type="submit" class="btn btn-success" id="submitBtn">Register District Secretary</button>
        </div>
    </div>
</form>
            </div>
...
// `identity_proof`, `profile_photo`
    ...
    let url = selectedId ? 'api/d-secretary/update.php' : 'api/d-secretary/create.php';
