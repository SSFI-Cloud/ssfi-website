...
<div class="container-xxl flex-grow-1" style="padding: 0px 10px;">
    <div class="card mb-2">
        <div class="row p-2">
            <div class="col-md-8">
                <h6 class="card-header"><i class="ri-building-line"></i> State Event Details</h6>
            </div>
            <?php if(get_permission('state_event', 'is_add')){ ?>
    ...
    <div class="card">
        <div class="table-responsive text-nowrap">
            <table id="clubTable" class="table" style="width: 100%;"> 
                <thead>
                    <tr>  <?php if(get_permission('state_event', 'is_edit') ||  get_permission('state_event', 'is_delete')){ ?>
                        <th>Actions</th>
                        <?php } ?>
...
function getDataTable() {    
    ...
    destroy: true,
    ajax: {
        url: `api/s-events/read.php${queryString}`,
        type: 'GET'
    },
    ...
    columns: [
        {
            ...
            render: (data) => {
                ...
                // === EXISTING BUTTONS ===
                html += `<?php if(get_permission('state_event', 'is_edit')){ ?>
                ...
                html += `<?php if(get_permission('state_event', 'is_delete')){ ?>
                <?php } ?>`;
...
function editClub(id) {
   window.location.href = 'state-events.php?id='+id;
}
