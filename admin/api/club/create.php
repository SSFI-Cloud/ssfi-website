...
try {
    $stmt = $pdo->prepare("INSERT INTO tbl_clubs 
        (club_name, registration_number, contact_person, mobile_number, email_address, district_id, state_id, club_address, tshirt_size, established_year, logo_path, status, created_by, updated_by, created_at, updated_at) 
        VALUES (:club_name, :registration_number, :contact_person, :mobile_number, :email_address, :district_id, :state_id, :club_address, :tshirt_size, :established_year, :logo_path, :status, :created_by, :updated_by, NOW(), NOW())");
    ...
    $stmt->bindParam(':tshirt_size', $postData['tshirt_size']);
