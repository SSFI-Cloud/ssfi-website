...
// Log the request
error_log("secretary deletion request received");
...
try {
    ...
    if ($stmt->execute([':id' => $id])) {
        ...
        echo json_encode(["success" => true, "message" => "Secretary deleted successfully, logo removed"]);
    } else {
        echo json_encode(["success" => false, 'message' => 'Failed to delete Secretary']);
    }
