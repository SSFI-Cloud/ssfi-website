...
function sendWhatsappMessage($mobile_no,$username,$password){
    ...
    $whatsapp_message = "
*Secretory Registration - Verification Completed*
...
try {
                ...
                if ($email_address) {
                            $subject = "State Secretary Registration Verified Successfully";
                            $mail_message = '
                                            <html>
                                            <head>
                                              <style>
                                            ...
                                            <body>
                                              <div class="container">
                                                <p class="header">🎉 Congratulations! Your State Secretary Verification is <strong>Successful!</strong></p>
