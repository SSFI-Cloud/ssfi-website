...
// Fields to update
$updateFields = ['event_name', 'state_id', 'event_date', 'reg_start_date', 'reg_end_date', 'event_fees', 'venue', 'association_name', 'reg_no', 'title_of_championship', 'date','date1', 'event_description', 'status', 'event_remarks'];
...
try {
    ...
    if ($stmt->execute()) {
        echo json_encode(["status" => "success", "message" => "State Event updated successfully"]);
    } else {
