...
// id', 'name','address','city','state','pincode', 'mobile_number', 'status' , 'branch_id' , 'created_by', 'updated_by' ,'created_at' , 'updated_at'
// Declare all variables at the top
$branch_code = $branch_name = $prefix = $logoPath = $invoiceLogoPath = $address = $city = $state = $country = $postal_code = $gst = $mobile_number1 = $mobile_number2 = $email = $alternate_email = $timezone = $remarks = $status = $created_by = '';
$errors = [];
...
$requiredFields = ['branch_code', 'branch_name', 'city', 'state', 'country', 'postal_code', 'mobile_number1', 'email', 'status'];
$timezone = 1;
$created_by = 1;
...
try {
    $stmt = $pdo->prepare("INSERT INTO tbl_branch 
        (branch_code, branch_name, prefix, address, city, state, country, postal_code, gst, mobile_number1, mobile_number2, email, alternate_email, timezone, remarks, status, created_by, created_at) 
        VALUES 
        (:branch_code, :branch_name, :prefix, :address, :city, :state, :country, :postal_code, :gst, :mobile_number1, :mobile_number2, :email, :alternate_email, :timezone, :remarks, :status, :created_by, NOW())");
