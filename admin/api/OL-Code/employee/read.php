...
$columns = [`id`, `employee_id`, `name`, `age`, `designation_id`, `role_id`, `branch_id`, `department_id`, `address`, `salary`, `doj`, `doe`,`role`,`email`,`password`, `status`, `created_at`, `updated_at`, `created_by`, `updated_by`];

// `id`, `employee_id`, `name`, `age`, `designation_id`, `role_id`, `branch_id`, `department_id`, `address`, `salary`, `doj`, `doe`, `status`, `created_at`, `updated_at`, `created_by`, `updated_by`);
    ...
    // Fetch data query
    $sqlData = "SELECT * FROM tbl_employee  $whereClause ORDER BY $orderBy $orderDir";
    ...
    $sqlTotal = "SELECT COUNT(*) as total FROM tbl_employee";
    $totalRecords = $pdo->query($sqlTotal)->fetchColumn();

    // Total filtered records count (with filtering)
    $sqlFiltered = "SELECT COUNT(*) as total FROM tbl_employee $whereClause";
