                    ...
                    <div class="dropdown-shortcuts-list scrollable-container">
                      <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="booking.php" class="stretched-link">Booking</a>
                        ...
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="master-client.php" class="stretched-link">Client</a>
                          <small class="mb-0">Client Accounts</small>
                        </div>
                      </div>
                      <div class="row row-bordered overflow-visible g-0">
                        <div class="dropdown-shortcuts-item col">
                          ...
                          <a href="master-users.php" class="stretched-link">User App</a>
                    ...
                    <li class="dropdown-menu-header border-bottom py-50">
                      <div class="dropdown-header d-flex align-items-center py-2">
                        ...
                        <div class="d-flex align-items-center">
                          <span class="badge rounded-pill bg-label-primary fs-xsmall me-2">0</span>
                          <a
                            href="javascript:void(0)"
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="assets/img/favicon/SSFI_main.png" alt class="rounded-circle" />
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-medium d-block small">SSFI</span>
                            <small class="text-muted"><?=$session_all['full_name']?></small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <div class="d-grid px-4 pt-2 pb-1">
                        <a class="btn btn-sm btn-danger d-flex" href="api/auth/logout.php">
