...
<div class="container-xxl flex-grow-1" style="padding: 0px 10px;">
    <div class="card mb-2">
        <div class="row p-2">
            <div class="col-md-8">
                <h6 class="card-header"><i class="ri-building-line"></i> District Secretary Reports</h6>
            </div>
    ...
    <div class="card">
        <div class="table-responsive text-nowrap">
            ...
            <!--`id`, `branch_id`, `user_id`, `role_id`, `username`, `password`, `status`, `full_name`, `gender`, `email_address`, `mobile_number`, 
            `aadhar_number`, `residential_address`, `state_id`, `district_id`, 
            `identity_proof`, `profile_photo`, `created_by`, `updated_by`, `created_at`, `updated_at`-->
                <thead>
                   <tr>
                        <th>S.No</th>
                         <th>Full Name</th>
