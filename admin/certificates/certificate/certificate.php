...
//         e.event_name, e.event_image, e.date, e.date1, e.venue, e.association_name,s.profile_photo,
//         er.created_at ,eel.event_level,er.prize_announcement_place,
//         GROUP_CONCAT(eel.event_level ORDER BY eel.event_level SEPARATOR ', ') AS all_event_levels,
//     GROUP_CONCAT(er.prize_announcement_place ORDER BY er.prize_announcement_place SEPARATOR ', ') AS prize_places,
//     GROUP_CONCAT(er.is_present ORDER BY er.is_present SEPARATOR ', ') AS is_present
//     FROM tbl_event_registration er 
//     LEFT JOIN tbl_skaters s ON er.skater_id = s.id 
//     LEFT JOIN tbl_events e ON e.id = er.event_id
//     LEFT JOIN tbl_clubs c ON s.club_id = c.id
...
/*}*/
    ...
    /*  height: auto;*/
      ...
      /* Fit image within the area without cropping */
    /*  object-fit: contain;*/
  ...
  <div class="header-text">
    <div style="max-width: 100%; width: fit-content; margin: auto; text-align: center;">
      <p style="font-size: clamp(15px, 5vw, 30px); word-wrap: break-word; color:#06038d;">
        <b style="font-size: <?= $font_size_ass ?>;"><?= $ass_name; ?> <small><sup>&reg;</sup></small></b>
      </p>
    </div>
...
?>
  ...
  <div class="content-area">
    <br>Member Id : <span style='color:#06038d;'><?= $a['membership_id']; ?></span><br>
    This is to certify that 
    <b class=" skater_name" style="width: 50%;color:#06038d;"><?= strtoupper($a['full_name']) ?></b><span class="dashed">...............................................................................................................................................................</span>
    in the Age Category <br>
    <b class="bor_v" style="width: 14%;color:#06038d;"><?= strtoupper($a['age_category']) ?></b><span class="dashed">........................................</span> has participated in the 
    <b class="bor_v" style="width: 60%;color:#06038d;font-size: clamp(12px, 5vw, 15px);"><?= strtoupper($a['event_name']) ?></b><span class="dashed">.............................................................................................................................................................</span><br>
    held on 
    <b class="bor_v" style="width: 28%;color:#06038d;"><?= strtoupper($event_date) ?></b><span class="dashed">......................................................................</span> at 
    <b class="bor_v" style="width: 50%;color:#06038d;"><?= strtoupper($a['venue']) ?></b><span class="dashed">.........................................................................................................................................................</span><br>
    Representing 
    <b class="bor_v" style="width: 45%;color:#06038d;"><?= strtoupper($a['club_name']) ?></b><span class="dashed">.....................................................................................................................</span> Club 
    <b class="bor_v" style="width: 30%;color:#06038d;"><?= strtoupper($a['club_district']) ?></b><span class="dashed">.......................................................................................</span><br>
    District 
    <b class="bor_v"  style="width: 50%; font-size: <?= $font_size ?>;color:#06038d;"><?= $school_name ?></b><span class="dashed">...................................................................................................................................</span> School and ranked as under
    ...
    $count_check_output = strtoupper(implode(' , ', $output));
$font_size_output = (strlen($count_check_output) > 55) ? '14px' : 'inherit';
    ...
    <div class="results" style="line-height:35px;padding-right: 250px;">
      ...
      <p style="font-size: clamp(10px, 3vw, 16px); word-wrap: break-word;color:#06038d;font-size: <?=$font_size_output?>"><?= $count_check_output;?></p> 
      <!--<br>-->
...
?>
    ...
    <img src="seal-tnssa.png" class="skater-logo-seal">
