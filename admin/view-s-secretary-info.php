                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div style="padding-left:10px;">
                                    <center>
                                        <img id="profile_photo" src="https://ssfibharatskate.com/ssfi/admin/assets/img/favicon/ssfa.png" style="width: 200px;height:200px;"><br>
                                        <a class="btn btn-xs btn-info rounded-pill" id="profile_photo_download" href="https://ssfibharatskate.com/ssfi/admin/assets/img/favicon/ssfa.png" download>Download</a>
                                    </center>
                                </div>
                            ...
                            <center><b style="color:blue;">Identity Proof</b></center>
                                <div style="padding-left:10px;">
                                    <center>
                                        <img id="identity_proof" src="https://ssfibharatskate.com/ssfi/admin/assets/img/favicon/ssfa.png" style="width: 200px;height:200px;"><br>
                                        <a class="btn btn-xs btn-info rounded-pill" id="identity_proof_download" href="https://ssfibharatskate.com/ssfi/admin/assets/img/favicon/ssfa.png" download>Download</a>
                                    </center>
                                </div>
                            </div>
                            <div class="col-sm-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to Approved this State Secretary?
            </div>
        ...
        $.get(`api/s-secretary/read_single.php?id=${encodeURIComponent(id)}`, function (data) {
            if (data) {
                ...
                if (data.profile_photo) {
                    ...
                    $('#profile_photo_download').attr('href', `${data.profile_photo}`);
                };
                if (data.identity_proof) {
                    $('#identity_proof').attr('src', `${data.identity_proof}`).show();
                    $('#identity_proof_download').attr('href', `${data.identity_proof}`);
                };
                if (data.verified==1) {
...
$('#confirmVerify').click(function () {  // Use `#confirmVerify` instead of `#verifyModal`
    if (verifyId) {
        $.ajax({
            url: `api/s-secretary/update_verify.php`,
            type: 'POST',
...
$('#confirmVerifys').click(function () {  // Use `#confirmVerify` instead of `#verifyModal`
    if (verifyIds) {
        $.ajax({
            url: `api/s-secretary/resend_msg.php`,
            type: 'POST',
            contentType: 'application/json',
