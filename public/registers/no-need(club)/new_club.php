...
@keyframes spin {
    ...
    100% { transform: rotate(360deg); }
            ...
            <!--                      <center><h6>Skater Registeration Verify Your Mobile Number & Aadhar Number.</h6></center>-->
            <!--                        <div class="row">-->
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    ...
                                    <div class="box">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <label for="date_of_birth">Age <small>(Auto calculated based on date of birth) : <b id="days"></b></small></label>
