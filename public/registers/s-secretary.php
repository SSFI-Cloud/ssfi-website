<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>STATE SECRETARY REGISTRATION</title>
                                  ...
                                  <center><h6>Login with whatsapp mobile number.</h6></center>
                                    <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                ...
                                                <small>(You will receive OTP on this WhatsApp mobile number)</small></label>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    ...
                                    <div class="box">
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="box">
                                                    <div class="ui-field-contain">
                                                        <label for="profile_photo">Secretary Passport Size Photo</label>
                                                        ...
                                                        <br><span style="font-size:12px">* Note: Only WEBP, PNG, JPG, and JPEG formats are supported.</span>
                                                    </div>
                                                </div>
                                            </div>
                                              <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="box">
                                                    <div class="ui-field-contain">
                                                        ...
                                                        <input type="file" name="president" id="president" accept="image/png, image/jpg, image/jpeg, image/webp" max-size=1024 />
                                                        <br><span style="font-size:12px">* Note: Only WEBP, PNG, JPG, and JPEG formats are supported.</span>
                                                    </div>
                                                </div>
                                            </div>
                                              <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="box">
                                                    <div class="ui-field-contain">
                                                        ...
                                                        <input type="file" name="treasurer" id="treasurer" accept="image/png, image/jpg, image/jpeg, image/webp" max-size=1024 />
                                                        <br><span style="font-size:12px">* Note: Only WEBP, PNG, JPG, and JPEG formats are supported.</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="ui-field-contain">
                                                    <label for="secretary_proof">Secretary ID Proof Image</label>
                                                    <input type="file" name="secretary_proof" id="secretary_proof" accept="application/pdf,image/png, image/jpg, image/jpeg" max-size=1024 required="required" />
                                                    <br><span style="font-size:12px">* Note: Only PDF, PNG, JPG, and JPEG formats are supported.</span>
                                                </div>
                                            </div>
                                             <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="ui-field-contain">
                                                    <label for="association_certificate">State Association Certificate</label>
                                                    <input type="file" name="association_certificate" id="association_certificate" accept="application/pdf,image/png, image/jpg, image/jpeg" max-size=1024 required="required" />
                                                    <br><span style="font-size:12px">* Note: Only PDF, PNG, JPG, and JPEG formats are supported.</span>
                                                </div>
                                            </div>
                                             <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="ui-field-contain">
                                                    <label for="association_logo">State Association Logo</label>
                                                    <input type="file" name="association_logo" id="association_logo" accept="application/pdf,image/png, image/jpg, image/jpeg" max-size=1024 required="required" />
                                                    <br><span style="font-size:12px">* Note: Only PDF, PNG, JPG, and JPEG formats are supported.</span>
                                                </div>
                                            </div>
                        ...
                        <div class="nd2-card" style="max-width:none">
                            <div class="row">
                              <div class="col-xs-12" style="padding:10px 20px;">
                                <div class="box">
                                  <center>
                                    <h5 id="txt_title">Your Annual Secretary Registered Already Completed and is Waiting for Approval</h5>
                                    <div id="payment_pending" style="padding:15px; font-family: Arial, sans-serif; background-color: #f9f9f9; border-radius: 8px; width:100%; margin: auto;">
                                        ...
                                        <p style="text-align: center;">To activate your State Association Registration account, please complete the payment of Rs.5000 /- using the below payment methods: </p>
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                          ...
                                          <div style="border: 1px solid gray;border-style: dashed;padding:10px;border-radius:10px;">
 ...
 $(document).ready(function () {
    ...
    $("#secretaryform").submit(function (e) {
            ...
            let form = $("#secretaryform");
                ...
                let url = '../admin/api/front-api/s-register-secretary.php';
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(res.status === "success") {
                    ...
                    }else if(res.type==2 && 0){ //call order create api
                        alert('Option Coming Soon...');
                    }else if(res.type==3 || res.type==2){ //go for payment
                        /*$('#txt_title').text(res.message);
                        $('#confirm_name').text(res.data.full_name);
