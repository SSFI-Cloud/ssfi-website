<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="https://ssfibharatskate.com/ssfi/admin/assets/img/favicon/ssfi-logo-12.png" />
            ...
            <div data-role="header" style="overflow:hidden; text-align:center;">
                ...
                <center>
                    <table style="text-align: center;">
                        <tbody>
                            <tr>
                                <td><img src="https://ssfibharatskate.com/ssfi/admin/assets/img/favicon/ssfi-logo-12.png" class="tnssa-logo" alt="tnssa logo" style="WIDTH: 70px;"></td>
                ...
                <center style="padding: 10px;"><b style="font-size: 16px;color: #afa300;">ANNUAL SKATER REGISTRATION 2025 - 2026</b></center>
            </div>
                                ...
                                <div class="box">
                                  <center><h6>Verification Process</h6></center>
                                    ...
                                    <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <label for="mob">Email ID<br>
                                                <small>(Otp has been sended to your mobile number or email-id)</small></label>
                                            </div>
                    ...
                    <div class="ui-content" data-inset="false">
                        <form id="skaterForm" autocorrect="off" spellcheck="false" autocomplete="false">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <center><b style="font-size: 14px;color: #3e4095;">Skater Club & Coach Information Details</b><br><br></center>
                                    <div class="box">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                ...
                                                <div class="box">
                                                    <div class="ui-field-contain">
                                                        ...
                                                        <input type="file" name="profile_photo" id="profile_photo" accept="application/pdf,image/jpeg" max-size=1024 required="required" />
                                                          ...
                                                          <span style="font-size:12px">(Upload Passport Size Photo Only) <br>*Note: Only WEBP, PNG, JPG, and JPEG formats are supported.</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
