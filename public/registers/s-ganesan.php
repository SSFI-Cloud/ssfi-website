                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="box">
                                                    <div class="ui-field-contain">
                                                        ...
                                                        <input type="file" name="profile_photo" id="profile_photo"  max-size=1024 required="required" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="ui-field-contain">
                                                    ...
                                                    <input type="file" name="identity_proof" id="identity_proof"  max-size=1024 required="required" />
                                                </div>
                                            </div>
