                            ...
                            <form id="eventForm">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                                ...
                                                <select class="form-select" id="suit_size"  class="form-control" required>
...
function pay(skater_id,event_id) {
    ...
    $("#otpForm").submit(function (e) {
            ...
            $.ajax({
                url: "api/verify_otp_another_national.php",  // Replace with your actual API endpoint
                type: "POST",
    ...
    $("#eventForm").submit(function (e) {
      ...
      $("#loader").show();  
        if(checked_count<2){
            ...
            $.ajax({
                url: "api/another-national-event-register-api.php",  // Replace with your actual API endpoint
                type: "POST",
                data: {  skater_id: skater_id,event_level_type_id:event_level_type_id,event_id:event_id,eligible_event_level_id:eligible_event_level_id,suit_size:suit_size },
                dataType: "json",
                success: function(response) {
                    //console.log(response)
                    let res = response;
...
$(document).ready(function () {
    $('#verify_member_id').on('keyup', function () {
        ...
        if (input.length >= 4) {
            $.ajax({
                url: 'api/fetch_members_national_api.php',
                method: 'POST',
                data: { query: input },
