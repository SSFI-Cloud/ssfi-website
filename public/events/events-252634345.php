                                ...
                                <div class="box">
                                  ...
                                  <center><h6>Skater Event Regsiter</h6></center>
                                    <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <label for="aadhar_number">Member Register ID<br>
                                                <small style="color:green;font-weight:bold;">(SSFI/BS/TN/25/S000 or ssfi/Bs/Tn/25/S000)</small></label>
                                                <input type="text" name="verify_member_id" id="verify_member_id"  value="" data-clear-btn="true" placeholder="Member Register ID"  required="required">
                        ...
                        <form id="skaterForm" autocorrect="off" spellcheck="false" autocomplete="false">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="box">
                                                    <div class="ui-field-contain">
                                                        ...
                                                        <input type="file" name="profile_photo" id="profile_photo" accept="image/*" max-size=1024 required="required" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="ui-field-contain">
                                                    <label for="dobfile">AADHAAR (Upload any age Proof)</label>
                            ...
                            <div class="row">
                                <div class="col-xs">
                                    ...
                                    <center><input type="submit" id="submitBtn" value="I agree to abide by SSFI Rules & Submit" class="ui-btn clr-btn-green btn-xs" /></center>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="row">
                              <div class="col-xs-12" style="padding:10px 20px;">
                                <div class="box">
                                  ...
                                  <br>
                                  <div>
                                    <button style="color:white;" class="ui-btn ui-corner-all ui-shadow clr-btn-green ui-btn-icon-left ui-icon-pen clr-white">
...
if (dob) {
    ...
    $("#emailForm").submit(function (e) {
        ...
        $("#loader").show();
            $.ajax({
                ...
                type: "POST",
                data: {mobile_no:mobile_no,member_id:member_id,email:email },
                dataType: "json",
                success: function(response) {
                    let res = response;
                    console.log(response);
    ...
    $("#otpForm").submit(function (e) {
            ...
            $.ajax({
                ...
                $('#submitbtn').prop('disabled', false).html('Verifiy Otp >>');
                $('#spinner').hide();
                 $('#otpForm').show();
