                                    ...
                                    <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                ...
                                                <small>(OTP will be sent to this email ID.)</small></label>
                                                    <input required="required" type="email" name="verify_email_id" id="verify_email_id" value="ganesan.firstmatrix@gmail.com" data-clear-btn="true" data-clear-btn="true" placeholder="Type Email Address...">
                                                    
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <label for="mob">Mobile No<br>
                                                <small>(OTP will be sent to this whatsapp mobile number.)</small></label>
                                                    <input required="required" type="number" name="verify_mobile_no"  maxlength="10" id="verify_mobile_no" value="8124455952" data-clear-btn="true" data-clear-btn="true" placeholder="Type Mobile Number...">
...
function pay(skater_id,event_id) {
    ...
    $("#otpForm").submit(function (e) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {  otp: otp,mobile_no:mobile_no,member_id:member_id,email:email,event_id:event_id },
                dataType: "json",
                success: function(response) {
                    //console.log(response)
                    let res = response;
    ...
    $("#eventForm").submit(function (e) {
      ...
      $("#loader").show();  
        if(checked_count<2){
            ...
            $.ajax({
                url: "api/event-register-api.php",  // Replace with your actual API endpoint
                type: "POST",
