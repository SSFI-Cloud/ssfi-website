        ...
        <div data-role="page" id="entrypage" data-url="entrypage">
            ...
            <div class="row">
                    <div class="col-xs-8 col-sm-8 col-md-8" style="text-align:right;">
                        <!--<a onclick="Link('../../')"  style="color: white;padding: 3px 7px;background: #d55353;" class="inline-btn"><< << Back to Home</a>-->
                        <!--<a onclick="Link('state_event_type_backend.php')"  style="color: white;padding: 3px 7px;background: #d55353;" class="inline-btn"><< << Back to Event List</a>-->
                    </div>
            </div>
