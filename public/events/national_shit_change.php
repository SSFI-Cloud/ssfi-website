<?php include "state_header2.php";
include '../admin/config/config.php';

$event_id= $_GET['event_id'] ?? 14;
                            ...
                            <div class="row">
                              <div class="col-xs-12" style="padding:10px 20px;">
                                <div class="box">
                                  ...
                                  <center><h6>Skater Natinal Event Suit Change</h6></center>
                                    <div class="row">
...
function pay(skater_id,event_id) {
    $.ajax({
        url: '../admin/api/front-api/get-event-payment1.php',
        type: 'POST',
        dataType: 'json',
        ...
        success: function (response) {
           //console.log(response);
                if (response.status == "success") {
                    ...
                    $('#confirm_certicate_download').attr('href', "state-event-confirmation-pdf.php?id=" + response.data.id+"&event_id="+response.data.event_id);
    ...
    $("#otpForm").submit(function (e) {
            ...
            $.ajax({
                url: "api/state_verify_otp1.php",  // Replace with your actual API endpoint
                type: "POST",
    ...
    $("#eventForm").submit(function (e) {
      ...
      $("#loader").show();  
        ...
        if(1){
            ...
            $.ajax({
                url: "api/state2-event-register-api-backend.php",  // Replace with your actual API endpoint
                type: "POST",
                ...
                data: {  state_event_level_type_id:state_event_level_type_id,skater_id: skater_id,event_level_type_id:event_level_type_id,event_id:event_id,eligible_event_level_id:eligible_event_level_id },
                dataType: "json",
                success: function(response) {
                    //console.log(response)
                    let res = response;
    ...
    var options = {
        ...
        "handler": function (response) {
            ...
            .then(data => {
                ...
                $('#confirm_certicate_download').attr('href', "state-event-confirmation-pdf.php?id=" + data.data.id+"&event_id="+data.data.event_id);
                $('#contiue_with_payment').hide();
                $("#event_register").hide();
                $("#event_confirmation").show();
            })
...
$(document).ready(function () {
    ...
    $('#verify_member_id').on('keyup', function () {
        ...
        if (input.length >= 4) {
            $.ajax({
                url: 'api/fetch_members_suit.php',
                method: 'POST',
                data: { query: input },
