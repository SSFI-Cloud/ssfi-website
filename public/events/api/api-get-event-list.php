...
$event_type_id=$_GET['event_type_id'] ?? 1;
$search=$_GET['search'] ?? '';
$session_id=$_GET['session_id'] ?? 4;

$condition=" and state_id=".$state_id." and district_id=".$district_id." and event_level_type_id=".$event_type_id ." AND NOW() BETWEEN reg_start_date AND reg_end_date";
...
<div class="col-lg-4 col-md-6 col-sm-12" >
    <div style="border: 1px solid gray;border-style: dotted;border-radius: 10px;padding: 12px 15px;margin:2px;">
        ...
        <center><a onclick=Link("events-2526-ui.php?event_id=<?=$res['id']?>");>Register Now</a></center>
    </div>
</div>
<?php } }else{ ?>
