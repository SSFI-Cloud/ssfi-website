...
$condition=" and state_id=".$state_id." and event_level_type_id=".$event_type_id ." AND reg_end_date >= NOW()";
...
<div class="col-lg-4 col-md-6 col-sm-12" >
    <div style="border: 1px solid gray;border-style: dotted;border-radius: 10px;padding: 12px 15px;margin:2px;">
        ...
        <center><a onclick=Link("state-meet-register-backend.php?event_id=<?=$res['id']?>");>Register Now</a></center>
    </div>
</div>
<?php } }else{ ?>
