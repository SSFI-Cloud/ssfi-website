...
<div class="container">
    ...
    <h4>ANDHRA PRADESH SPEED SKATING ASSOCIATION</h4>
    ...
    <div class="tab-container" style="margin-top:10%;">
        ...
        <button class="tab" onclick="openTab(event, 'Registered')">Registered Skaters 2021-22</button>
        <button class="tab active" onclick="openTab(event, 'District')">District & State Championships 2022-23</button>
