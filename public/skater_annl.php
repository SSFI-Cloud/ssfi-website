...
<div class="container">
    <h3 class="">Registered Skaters 2025-26</h3>
...
<body>
    ...
    <div class="tab-container" style="margin-top:10%;">
        ...
        <button class="tab" onclick="openTab(event, 'Andaman')">Andaman Nicobar</button>
     <button class="tab active" onclick="openTab(event, 'Andhra')">Andhra Pradesh</button>
        <button class="tab" onclick="openTab(event, 'Arunachal')">Arunachal Pradesh</button>
    </div>
   ...
   <div id="Dashboard" class="tab-content">
    ...
    <!--district unit-->
      <div id="Andaman" class="tab-content">
       <style>
        body {
            font-family: Arial, sans-serif;
        }
 ...
 <div id="Andhra" class="tab-content">
       <style>
        body {
            font-family: Arial, sans-serif;
        }
    ...
    <div id="Arunachal" class="tab-content">
       <style>
        body {
            font-family: Arial, sans-serif;
        }
